                ...
                <el-col class="block" style="padding: 0">
                    <el-card style="margin: 15px 100px 0 100px;"
                        ...
                        <el-image
                            ...
                            :key="downSrc"
                            :src="downSrc"/>
                        <div style="padding-bottom: 10px;padding-left: 30px;padding-right: 30px"
                             class="upload-demo">
                            <el-button type="primary" @click="dowmImg">下载图片</el-button>
                        </div>
                    </el-card>
                </el-col>
            </el-row>
...
const formData = reactive([
    ...
    ['max_value', '', '255', true],
    ['threshold_type', '', 'cv2.THRESH_BINARY', false],
])
...
const handleSuccess: UploadProps['onSuccess'] = async(response: any, uploadFile: UploadFile, uploadFiles: UploadFiles)=> {
    ...
    console.log("请求成功"+imgFlog.value)
}
